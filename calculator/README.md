...
- **Дополнительные математические операции**
 1. `25 v  => 5` или ` v 25  => 5` - любой вариант правильный
 2. `9 v + 1  => 4` или ` v 9 + 1  => 4` - любой вариант правильный
 3. `2 ^ 2 => 4`
 4. `15 ^ 3 => 3375`
 5. `10.1 ^ 3 => 1030.301`
- **Действия с отрицательными числами**
 ...
 3. `2 / -2 => -1`
 4. `-9 ^ 3   => -729`
 5. `-9 v  => уведомление об ошибке` или ` v - 9 => уведомление об ошибке` - любой вариант правильный
- **Действия с дробями**
 1. `0.1 + 0.2  => 0.3`
 2. `0.4 - 0.1 => 0.3`
